package com.example.postgresql.redis.util;
...
public class ReactiveRedisComponent {
    ...
    public Mono<Object> setKeyValues(String key, Object val) {
        return redisOperations.opsForValue().set(key, val).map(b -> val);
    }
